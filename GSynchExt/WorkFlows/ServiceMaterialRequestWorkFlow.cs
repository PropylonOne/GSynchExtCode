...
using static PX.Data.WorkflowAPI.BoundedTo<GSynchExt.ServiceMaterialRequestEntry, GSynchExt.ServiceMaterialRequest>;

namespace GSynchExt.WorkFlows
{
    public class ServiceMaterialRequestWorkFlow : PX.Data.PXGraphExtension<ServiceMaterialRequestEntry>
    {
        #region Constants
        ...
        public override void Configure(PXScreenConfiguration config)
        {
            ...
            var context = config.GetScreenConfigurationContext<ServiceMaterialRequestEntry, ServiceMaterialRequest>();
            ...
            context.AddScreenConfigurationFor(screen =>
                     screen
                     .StateIdentifierIs<ServiceMaterialRequest.status>()
