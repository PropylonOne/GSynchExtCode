...
namespace GSynchExt
{
    public class LECOLocations : IBqlTable
    {
        ...
        [PXParent(typeof(SelectFrom<Provinces>.Where<Provinces.stateID.IsEqual<LECOLocations.stateID.FromCurrent>>))]
    ...
    //    [PXReferentialIntegrityCheck]
        ...
        [PXDefault(GSynchExt.DUtility.LECO)]
